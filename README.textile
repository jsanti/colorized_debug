...
%{colored:green}--------------------------------------------------------------------------------%
%{colored:red}#<User id: 1, login: "jnay", crypted_password: "covzxvzx09c8vx8v", password_salt: "covzxvzx09c8vx8v", persistence_token: nil, single_access_token: nil, perishable_token: nil, login_count: 12, account_id: 1, email: "jay@nay.com", enabled: true, firstname: "Jay", lastname: "Nay", created_at: "2008-12-03 03:58:39", updated_at: "2008-12-03 03:58:39">%
%{colored:green}--------------------------------------------------------------------------------%
